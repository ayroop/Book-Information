...
class BookInformationPlugin extends Singleton {
    ...
    private function loadPluginTextDomain() {
        ...
        load_plugin_textdomain( 'book-information', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
    }
    ...
    private function registerActivationHooks() {
        ...
        $this->application->onDeactivation( function () {
            // Flush rewrite rules upon deactivation if needed
            flush_rewrite_rules();
        } );
    }
            ...
            add_action( 'admin_notices', function () use ( $e ) {
                \Rabbit\Redirects\AdminNotice::permanent( [
                    ...
                    'message' => sprintf(
                        ...
                        __( 'Error initializing Book Information plugin: %s', 'book-information' ),
    ...
    private function registerServiceProviders() {
        ...
        // Load plugin-specific service providers
